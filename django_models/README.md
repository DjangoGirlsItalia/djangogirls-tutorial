...
Digita `python3 manage.py makemigrations blog` (o `python manage.py makemigrations blog` a seconda del tuo sistema operativo). Il risultato somiglierà a questo:
...
Digita `python3 manage.py migrate blog` (o `python manage.py migrate blog` a seconda del tuo sistema operativo) e l'output dovrebbe essere:
